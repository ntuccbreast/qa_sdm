...
export const questionsBctSm = [
  ...
  {
    id: "Q_BREAST_IMAGE",
    topic: "保留原本乳房的外觀，對您有多重要？",
    assistantScript: `
      體驗完兩條路之後，我想請您思考一個關於外觀的問題。
      有一點要先說明：雖然全乳房切除可以搭配重建，讓您不是空著的，
      但重建後的外觀和觸感，與原本自然的乳房還是會有所不同——
      形狀、對稱性、觸感都可能和以前不一樣，也不一定有原本的乳頭乳暈。
      相對地，部分乳房切除保留了大部分的原本組織，外觀最接近自然。
      知道這個差別之後，請問您：盡量維持原本自然乳房的外觀，對您有多重要？
    `,
    question: `
      <p>體驗過兩條路之後，有一點要先釐清：</p>
      <br/>
      <p>全乳房切除雖然可以搭配重建，但<strong>重建後的外觀與觸感，和原本自然的乳房仍然不同</strong>——形狀、對稱性、觸感都可能有落差，也不一定有原本的乳頭乳暈。</p>
      <br/>
      <p>部分乳房切除則保留了大部分原本的乳房組織，外觀最接近自然。</p>
      <br/>
      <p>知道這個差別後，<strong>盡量維持原本自然乳房的外觀，對您來說有多重要？</strong></p>
    `,
    descriptionText:
