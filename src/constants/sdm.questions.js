...
export const questionsBctSm = [
  ...
  // ── 路線 A：BCT+SLNB 旅程 ──
  {
    ...
    assistantScript: `
      ...
      部分乳房切除保留了大部分原本的乳房組織，外觀最接近自然。
      這裡我想先問您一個問題：雖然全乳房切除也可以搭配重建，
      但重建後的外觀和觸感，與原本自然的乳房還是會有所不同——形狀、對稱性、觸感都可能有落差。
      知道這個差別後，請問對您來說，維持原本自然乳房的外觀有多重要？
    `,
    question: `
      ...
      <br/>
      <p><em>補充說明：全乳房切除雖然可以搭配重建，但重建後的外觀與觸感和原本自然的乳房仍有差異（形狀、對稱性、乳頭乳暈等）。</em></p>
      <br/>
      <p><strong>維持原本自然的乳房外觀，對您來說有多重要？</strong></p>
    `,
    hints: {
      bctsm_bct_flow: {
        type: "image",
    ...
    options: [
      {
        label: "很重要——我希望盡量維持原本自然的外觀",
        nextId: "BCT_A2_MARGIN_LN",
      },
      {
        label: "不是我最優先的考量，治療方便或其他因素對我更重要",
        nextId: "BCT_A2_MARGIN_LN",
      },
    ],
  },
...

  {
    ...
    topic: "SM｜您對乳房重建有意願嗎？",
    assistantScript: `
      關於全乳房切除後的乳房重建，想再多了解您的想法。
      重建是自費的項目，可以在同次手術立即完成，也可以等所有治療結束後再做，或是選擇不重建。
      不管您現在的意願如何，都可以再和醫師討論。
      請問您對乳房重建有意願嗎？
    `,
    question: `
      ...
      <br/>
      <p>
        ✦ <strong>立即重建</strong>（同次手術完成）：義乳植入或自體組織，需自費<br/>
        ✦ <strong>延遲重建</strong>：等治療全部結束後再評估，保留彈性<br/>
        ✦ <strong>不重建</strong>：以平整方式縫合，不需額外手術
      </p>
      <br/>
      <p><strong>目前對重建，您有意願考慮嗎？</strong></p>
    `,
    options: [
      { label: "我有意願考慮重建，了解需自費", nextId: "SM_B2_LN" },
      { label: "我不考慮重建，切除就好", nextId: "SM_B2_LN" },
    ],
  },
