...
export const questionsBctSm = [
...

  {
    ...
    question: `
      ...
      <br/>
      <p><strong>先問您關於療程安排：每週一至五、每天到醫院，連續 4～8 週——這樣的時間安排，您能配合嗎？</strong></p>
    `,
    hints: {},
    options: [
      {
...

  {
    ...
    topic: "BCT｜放療副作用：您能接受嗎？",
    assistantScript: `
      接下來問您對放療副作用的感受。
      最常見的副作用是皮膚反應，類似曬傷，放療結束後幾週就會恢復。
      另外，左側腫瘤極少數情況下可能輕微影響心肺，醫師通常會調整照射角度來降低風險。
      整體療程期間也可能感到疲倦，多休息即可。
      請問這些可能的副作用，對您來說是能接受的嗎？
    `,
    question: `
      <p><strong>關於放療可能出現的副作用，您能接受嗎？</strong></p>
      <br/>
      <p>
        🔴 <strong>皮膚反應</strong>：泛紅、乾燥，類似曬傷感；放療結束後數週內恢復，大多人都能撐過去<br/>
        💙 <strong>心肺影響</strong>：機率極低，多見於左側腫瘤；醫師會調整照射角度降低風險<br/>
        😴 <strong>疲倦感</strong>：療程期間容易疲勞，充分休息即可
      </p>
    `,
    options: [
      {
